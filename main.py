...
# FastAPI supports dependencies that do something after solving dependency *(use 'yield' instead of return) eg. create a db session + close it after finishing. The yielded value gets injected into path operation + other dependencies. EXAMPLE:
# async def get_db():
#     db = DBSession()
#     try:
#         yield db
